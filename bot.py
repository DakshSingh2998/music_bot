...
async def on_ready():
  ...
  try:
      access_key='AKIAR5LGW6QDRJROEEGL'
      access_secret='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'
      bucket_name='discordmusic'
...
async def save_( ctx):
    ...
    try:
        ...
        await ctx.send(f'**`{ctx.author}`**: State Saved!',delete_after=10)
        await ctx.message.delete()
...
client.run('ODI3MjkwMTI5MDA0NDk0ODc4.YGY3-Q.aqdafP2_1jizmcc1zAy6yQbyDjE')
