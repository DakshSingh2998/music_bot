...
class YTDLSource(discord.PCMVolumeTransformer):
    ...
    async def regather_stream(cls, data, *, loop):
        ...
        global timeestamp
        ffmpegopts = {
        'before_options': f'-nostdin -ss {timeestamp} -flags2 fast -fflags nobuffer -flags low_delay -reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 10',
...
class MusicPlayer:
    ...
    __slots__ = ('bot', '_guild', '_channel', '_cog','ispaused','idd', 'queue','startt','stopt', 'next', 'current', 'np', 'volume','que','embed','nowp','searchqueue','cttx','elapsed')
