...
class YTDLSource(discord.PCMVolumeTransformer):
    ...
    async def create_source(cls, ctx, search: str, *, loop, download=False):
        ...
        ffmpegopts = {
        'before_options': f'-vn -nostdin -ss {timeestamp} -reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 4000 -probesize 32 -fflags nobuffer -analyzeduration 0 -re -bufsize 300k' ,
        'options': f''
        }
