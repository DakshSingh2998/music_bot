...
class YTDLSource(discord.PCMVolumeTransformer):
    ...
    async def create_source(cls, ctx, search: str, *, loop, download=False):
        ...
        ffmpegopts = {
        'before_options': f'-vn -nostdin -ss {timeestamp} -reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 4000 -deadline realtime -b:a 64k -tune zerolatency -re' ,
        'options': f''
        }
    ...
    async def regather_stream(cls, data, *, loop):
        ...
        global timeestamp
        ffmpegopts = {
        'before_options': f'-vn -nostdin -ss {timeestamp} -reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 4000 -deadline realtime -b:a 64k -re',
        'options': f''
        }
